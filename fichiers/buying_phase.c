...
void decrementArticleQuantity(int target_line, int decrement){
    ...
    */
    ...
    FILE* product_file = fopen("produits.txt", "r");
    FILE* fichier_tmp = fopen("tmp.txt", "w");
    ...
    fclose(product_file);
    product_file = fopen("produits.txt", "r");
...
void buyArticle(char nom[],char prenom[], int ref_number, int target_line, char articleName[]){
    ...
    total_price = fopen("total_price.txt","w");
    if(product_file==NULL || total_price==NULL){exit(1);}
            ...
            do{  
                ...
                if(isIn == -1){
                    ...
                    if(wantDelAccount == 1){
                        ...
                        printf("\nProcedure de desincription en cours");printf(".");sleep(1);printf(".");sleep(1);printf(".");
                        exit(0);
                    }       
